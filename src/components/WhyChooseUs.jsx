...
const WhyChooseUs = () => {
  return (
    <section className="py-12 bg-gray-50 text-center">
      <h2 className="text-3xl font-bold mb-6 text-gray-800">Why Choose daily<span className="text-primary">FIX</span></h2>
      <div className="grid md:grid-cols-3 gap-6 px-6">
        ...
        <div className="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition">
          ...
          <h3 className="text-xl font-semibold mb-2">Transparent & Affordable</h3>
          <p className="text-gray-600">
